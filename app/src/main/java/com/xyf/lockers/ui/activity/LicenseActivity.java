...
public class LicenseActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected int getLayout() {
        return R.layout.activity_license_activate;
    }
    ...
    private void ifUserLicense() {
        ...
        Log.i(TAG, "ifUserLicense: status: " + status);
        switch (status) {
            case 0:
                return;
            case LICENSE_APP:
...
//        etKey.setText("CJFM-H0NN-ZGNV-9R5W");//安卓板
        etKey.setText("MCIP-BEMS-PUXC-DQPE");//一加手机
