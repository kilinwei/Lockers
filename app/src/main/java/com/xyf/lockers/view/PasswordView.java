...
import com.xyf.lockers.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout {
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        mCloseBtn = (ImageButton) view.findViewById(R.id.close_pwd_btn);

        mTitleTv = (TextView) view.findViewById(R.id.id_title);
    ...
    private void setupView() {
        ...
        tvList[0].addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public void setOnPasswordClose(final OnPasswordClose passwordClose) {
        mCloseBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (passwordClose != null) {
                    passwordClose.onPasswordClose();
                }
            }
        });
    }
    ...
    public interface OnPasswordClose {
        void onPasswordClose();
    }
